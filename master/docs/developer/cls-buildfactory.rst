...
Furthermore, the :meth:`setSkipBuildIf` can be used to set a produce which will skip the whole build. This is useful in case one want the build to be displayed in the UI, without incurring worker preparation costs.
